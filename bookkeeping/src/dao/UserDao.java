...
public class UserDao {
	...
	public User getUser(Connection connection, String accountOrEmail,
		...
		try {
			String sql = "SELECT * FROM twitter_db.user_tbl WHERE (account = ? OR email = ?) AND password = ?";
	...
	public void insert(Connection connection, User user) {
		...
		try {
			...
			sql.append("INSERT INTO twitter_db.user_tbl ( ");
			sql.append("account");
			sql.append(", name");
			sql.append(", email");
			sql.append(", password");
	...
	public void update(Connection connection, User user) {
		...
		try {
			StringBuilder sql = new StringBuilder();
			sql.append("UPDATE twitter_db.user_tbl SET");
			sql.append("  account = ?");
			sql.append(", name = ?");
			sql.append(", email = ?");
			sql.append(", password = ?");
	...
	public User getUser(Connection connection, int id) {
		...
		PreparedStatement ps = null;
		try {
			String sql = "SELECT * FROM twitter_db.user_tbl WHERE id = ?";
